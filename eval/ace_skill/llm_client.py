...
class ExperienceLLM:
    ...
    _global_sampling_overrides: Dict[str, Any] = {}

    @classmethod
    def configure_global_sampling(
        cls,
        ...
        """Set process-wide sampling defaults used by new ExperienceLLM instances."""
        overrides = {}
        ...
        cls._global_sampling_overrides = overrides
    ...
    def __init__(
        ...
        merged = dict(self._global_sampling_overrides)
        if temperature is not None:
        ...
        if repetition_penalty is not None:
            merged["repetition_penalty"] = repetition_penalty

        self.default_temperature = merged.get("temperature", 0.6)
        self.default_top_p = merged.get("top_p", 1.0)
        self.default_top_k = merged.get("top_k")
        self.default_presence_penalty = merged.get("presence_penalty")
        self.default_repetition_penalty = merged.get("repetition_penalty")
    ...
    def chat(
        ...
        pp = presence_penalty if presence_penalty is not None else self.default_presence_penalty
        rp = repetition_penalty if repetition_penalty is not None else self.default_repetition_penalty
            ...
            try:
                ...
                if resp.status_code == 200:
                    ...
                    if _is_qwen35_model(self.model_name):
                        content = _strip_after_think_tag(content)
    ...
    def _call_with_fallback(
        ...
        try:
            return self._try_single_experience_api(
                ...
                temperature, top_p, top_k, presence_penalty, repetition_penalty, max_retries,
